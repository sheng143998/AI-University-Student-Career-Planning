...
public class ResumeFileEditServiceImpl implements ResumeFileEditService {

    private final AliOssUtil aliOssUtil;

    /** 可直接编辑的简历文件格式 */
    private static final Set<String> EDITABLE_TYPES = ResumeConstant.EDITABLE_RESUME_FILE_TYPES;

    /** 技能区块识别关键词 */
    private static final Set<String> SKILL_SECTION_KEYWORDS = ResumeConstant.SKILL_SECTION_KEYWORDS;

    /** 下一个区块的标题关键词 */
    private static final Set<String> NEXT_SECTION_KEYWORDS = ResumeConstant.NEXT_SECTION_KEYWORDS;

    /** 当没有标题匹配时，回退密度算法的最小匹配数 */
    private static final int MIN_SKILL_MATCH_THRESHOLD = ResumeConstant.MIN_SKILL_MATCH_THRESHOLD;
